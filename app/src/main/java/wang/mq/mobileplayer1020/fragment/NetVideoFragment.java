...
import wang.mq.mobileplayer1020.activity.SystemVideoPlayerActivity;
import wang.mq.mobileplayer1020.adapter.NetVideoAdapter;
...
public class NetVideoFragment extends BaseFragment {
    ...
    class MyMaterialRefreshListener extends com.cjj.MaterialRefreshListener{
...
//        tv_no_media.setText("呵呵");
    ...
    private void processData(String json) {
        if (!isLoadMore){
            ...
            //刷新
            adapter.notifyDataSetChanged();//getCount   然后getView
        }
